...
# --- CONFIGURATION ---
GMAIL_USER = "commuteralerts1@gmail.com"
GMAIL_APP_PASSWORD = "mafv lzmq myfe vyuz"
GMAPS_API_KEY = "AIzaSyBtrZ7vzttTvPfOLt9EPjCY2nEIzI0WG3U"
...
def lambda_handler(event, context):
    # Get current time in HH:MM format (e.g., "07:15")
    ...
    for user in users:
        # SKIP if the user's schedule time does not match the current minute
